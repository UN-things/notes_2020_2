...
setwd('/root/Documentos/UN/UN_2020_2/DCD/module_4/class_5/r_project')
```
...
p1 <- ggplot(datos, aes(x=G)) + geom_histogram(color="coral", fill="coral")
p2 <- ggplot(datos, aes(x=W)) + geom_histogram(color="coral", fill="coral")
p3 <- ggplot(datos, aes(x=ADJOE)) + geom_histogram(color="coral", fill="coral")
p4 <- ggplot(datos, aes(x=ADJDE)) + geom_histogram(color="coral", fill="coral")
p5 <- ggplot(datos, aes(x=BARTHAG)) + geom_histogram(color="coral", fill="coral")
...
```{r}
# Silhouette - Calidad de la asignación para cada clouster
sil3 <- silhouette(kmeans_3k$cluster,dist(km_scale))
plot(sil3, main ="Silhouette plot - K-means 3 clusters", col = "brown4")

sil4 <- silhouette(kmeans_4k$cluster,dist(km_scale))
plot(sil4, main ="Silhouette plot - K-means 4 clusters", col = "brown4")
```
...
plot(sil_acp, main ="Silhouette plot - K-means 4 clusters a partir de ACP", col="brown4")
